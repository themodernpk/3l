<?php
/*
Template Name: Teacher Thankyou
*/
?>
    ...
    <div id="thankyou-popup"  class="zoom-anim-dialog  rating_form">
        <div class="thankyou_popup">
            <div class="media">
                ...
                <h5>Before using 3lemni you need to give all the necessary details and verify your Email ID</h5>
                <hr>

                <p>For any query related to 3lemni view <a href="<?php echo site_url(); ?>/how-it-works/">how it works,</a> <br>
                    You can start tutoring once the admin approves you, Happy tutoring!!
                </p>
...
<?php get_template_part('inc/document-end'); ?>