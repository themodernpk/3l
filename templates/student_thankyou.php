<?php
/*
Template Name: student_thankyou
*/
?>
            ...
            <div class="media" style="width: 100%;">
                <div class="media-left">
                    <div class="thankyou_ch">
                        <img class="" src="http://staging.webreinvent.com/demo/projects/3lemni/dev/wp-content/themes/3lemni/assets/img/thankyou_ch.png">
                    </div>
                </div>
                ...
                <h5>You need to verify your Email ID</h5>
                <hr>

                <p>For any query related to 3lemni view <a href="<?php echo site_url()">how it works,</a> <br>
