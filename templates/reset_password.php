...
<div class="margin_top_second">
<div id="reset-pass-form"  class="zoom-anim-dialog ">
	<div class="register_inner forgot_pass_form reset_pass_form">
		...
		<div class="display-flex">
			...
			<form  class="" data-parsley-validate="" method="POST" action="#">
				...
				<div class="form-group">
					<input type="password" placeholder="Confirm Passsword" class="form-control " id="confirm_passsword" name="confirm_passsword"  required="">
				</div>
